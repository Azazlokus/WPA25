...
<div class="container">
    ...
    <div class="row row-form">
        <div class="col-12">
            <form action="<?php echo get_template_directory_uri(); ?>/App/calculate.php" method="POST" id="form">
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/index/index.js"></script>
